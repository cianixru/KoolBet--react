        ...
        return (
            <section>
                <div className="tournament-group-name__container">
                    <div className="tournament-group-name">Main</div>
                </div>
                ...
                <div className="sport-table">
                    ...
                    <div className="row">
                        ...
                        <div className="cell-a match-specialoddvalue-value">
                            <div>
                                <div className="match-group" group-label="Match Bet">
                                    <div className="market-odds">
                                        <div className="cell">
                                            <div className="specialoddvalue-text btn-unavailable" data-oddtag="1">22.85</div>
                                        </div>
                                        <div className="cell">
                                            <div className="specialoddvalue-text btn-unavailable" data-oddtag="X">3.46</div>
                                        </div>
                                        <div className="cell">
                                            <div className="specialoddvalue-text btn-unavailable" data-oddtag="2">2.13</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="match-group" group-label="Draw No Bet">
                                    <div className="market-odds">
                                        <div className="cell">
                                            <div className="specialoddvalue-text" data-oddtag="1"><span className="odd--down">2.85</span></div>
                                        </div>
                                        <div className="cell">
                                            <div className="specialoddvalue-text" data-oddtag="2"><span className="odd--up">3.46</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="match-group" group-label="Double Chance">
                                    <div className="market-odds">
                                        ...
                                        <div className="cell">
                                            <div className="specialoddvalue-text" data-oddtag="X"><span className="odd--up">3.46</span></div>
                                        </div>
                                        <div className="cell">
                        ...
                        <div className="cell-s go-to-all-markets" data-toggle="toggle011 go-to-all-markets" id="go-to-all-markets" data-toggler=".active">
                            <div className="go-to-all-markets__button">+5</div>
                        </div>
                    </div>
                    ...
                    <div className="row date">
                        <div className="date-value">MAY 21TH</div>
                    </div>
