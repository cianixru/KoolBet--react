        ...
        return (
            <section>
                <div className="tournament-group-name__container">
                    <div className="tournament-group-name">Double Chance Combo</div>
                </div>
                ...
                <div className="sport-table">
                            ...
                            <div>
                                <div className="match-group">
                                    <div className="market-odds">
                                        <div className="cell">Double Chance + Total (1.5)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row subhead">
                        ...
                        <div className="cell-s combo-market-teams">
                            <div></div>
                        </div>
                        <div className="cell-a match-specialoddvalue-value">
                            <div>
                    ...
                    <div className="row">
                        ...
                        <div className="cell-a match-specialoddvalue-value">
                            <div>
                                <div className="match-group" group-label="Double Chance + Total (1.5)">
                                    <div className="market-odds">
                                        <div className="cell">
                            ...
                            <div>
                                <div className="match-group" group-label="Double Chance + Total (2.5)">
                                    <div className="market-odds">
                                        <div className="cell">
                                            <div className="specialoddvalue-text" data-oddtag="1X/YES">2.85</div>
                                        </div>
                            ...
                            <div>
                                <div className="match-group" group-label="Double Chance + Total (3.5)">
                                    <div className="market-odds">
                                        <div className="cell">
                                            <div className="specialoddvalue-text" data-oddtag="1X/YES">2.85</div>
                                        </div>
                            ...
                            <div>
                                <div className="match-group" group-label="Double Chance + Total (4.5)">
                                    <div className="market-odds">
                                        <div className="cell">
                                            <div className="specialoddvalue-text" data-oddtag="1X/YES">2.85</div>
                                        </div>
