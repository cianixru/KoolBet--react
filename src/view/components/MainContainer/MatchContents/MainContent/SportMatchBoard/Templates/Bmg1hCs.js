            ...
            <section>
                ...
                <div className="sport-table">
                    ...
                    <div className="row subhead">
                        <div className="cell-s match-start-time-value">
                            <div><FormattedMessage id="MainContainer.MatchContents.MainContent.SportMatchBoard.Templates.Bmg1hCs.Column.MatchStartTime" defaultMessage="TIME"/></div>
                        </div>
                        <div className="cell-s match-team-value">
                            <div><FormattedMessage id="MainContainer.MatchContents.MainContent.SportMatchBoard.Templates.Bmg1hCs.Column.TableEvents" defaultMessage="TABLE EVENTS"/></div>
                        </div>
                        <div className="cell-a match-specialoddvalue-value">
                            <div>
                                {this.state.markets
                                                        ...
                                                        .map((e, index) => {
                                                            return (
                                                                <div className="match-group" group-label={e.betTitleName} key={index}>
                                                                    <div className="market-odds templ--1H_C_SCORE">
                                                                        {
                                                                            group.Markets.map(market => {
